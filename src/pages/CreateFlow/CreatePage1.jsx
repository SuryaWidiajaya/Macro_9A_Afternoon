      ...
      <Layout hide="">
        <div className='flex my-[240px] flex-col items-center'>
          ...
          <div className="flex justify-center  ">
            ...
            <Link to='/home/create/data'>
              <button class=" text-white p-6 bg-[#1f298d] w-[160px] hover:bg-[#00085e]  border-2 border-[#1f298d] font-medium rounded-r-lg text-xl">Create</button>
            </Link>
          </div>
        </div>
      </Layout>
